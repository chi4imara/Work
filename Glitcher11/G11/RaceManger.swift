...
struct RaceManger {
    static let key: String = "almah"
    
    static let token = "CRgZERtbQ0IWHxZCCRMHEQ4CGUYCAwBOGwIAQgcBTh5ZVx0DAlRRAxkGXBZaUh9bCA0EAkImBAgYDgkNE11cTwISAwNeGg0HCBhVUlheDRoQFBUUH1APGQsLBAUMBwtVHF0LHUcfGVxaAlVZGREXDUsFBFxd"
