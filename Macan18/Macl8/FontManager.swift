...
class FontManager {
    ...
    static func playfairDisplay(size: CGFloat, weight: PlayfairWeight = .regular) -> Font {
        return Font.custom(weight.fontName, size: size)
    }
    
    static func playfairDisplayUIFont(size: CGFloat, weight: PlayfairWeight = .regular) -> UIFont {
...
extension Font {
    static func playfairDisplay(_ size: CGFloat, weight: PlayfairWeight = .regular) -> Font {
        return FontManager.playfairDisplay(size: size, weight: weight)
    }
}
