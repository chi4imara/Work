...
struct RaceManger {
    static let key: String = "argon"
    
    static let token = "CQYTHx1bXUgYGRZcAx0BERAIF0ACHQpAHQIeSAkHThYFVwQTC1JXBAAaDR9dFQReHVsWHEgoAggGBAcLE0NSQQQSHQlQHA0ZAhZTDxxeWQwbAQoXGlZGHgsFDAYFBgFVGQgVXkcBE1IcDwEKVwMWB0ELAlxD"
