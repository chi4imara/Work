...
struct AppColors {
    ...
    static let backgroundGradientStart = Color(red: 0.1, green: 0.5, blue: 0.8)
    ...
    static let statusIdea = primaryYellow
    static let statusPurchased = accentOrange
    static let statusGifted = accentGreen
