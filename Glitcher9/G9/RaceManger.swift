...
struct RaceManger {
    static let key: String = "abbes"
    
    static let token = "CRYWFQBbTU0SBBZMBhccEQANHV0CDQ9KAAIOTQMaTlRVEUZVC1ENGBNWDhUYU1NTCQoVEk0iHwgWAQ0WE1tMDwAODF0XHwoHG1gbGxYLDhZSEBVWHANVEQhHCAUYDENXW1MAVRIWX1EbUBsICEZZRAYJTlA="
