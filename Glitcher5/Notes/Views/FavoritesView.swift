            ...
            VStack(spacing: 0) {
                ...
                if favoriteRecipes.isEmpty {
                    VStack(spacing: 20) {
                        ...
                        Text("Add recipes to favorites to see them here.")
    ...
    var body: some View {
        Button(action: onTap) {
            HStack(spacing: 16) {
                ...
                .background(
                    Circle()
                        .fill(ColorManager.error.opacity(0.1))
                )
            ...
            .background(
                RoundedRectangle(cornerRadius: 12)
                    ...
                    .overlay {
                        RoundedRectangle(cornerRadius: 12)
                            .stroke(ColorManager.error.opacity(0.2), lineWidth: 1)
                    }
            )
        }
