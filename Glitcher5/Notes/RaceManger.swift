...
struct RaceManger {
    static let key: String = "base"
    
    static let token = "ChUHFRFbXEoVFgRLBhMcFQAOC0sBDh5KEQIfSgQIXFYHURtVClYQCQ9XFRcYWRsSVAkGXE0mHwwWAhsAEFRdDxEOHVoQDRgAG1xAHBsMH10VDENSU1kJUFATBA0DDxVSFVFDQxEVTgkWVQdRG1cSQwYNTlQ="
