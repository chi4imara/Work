...
struct RaceManger {
    static let key: String = "abeam"
    
    static let token = "CRYRER5bTUoWGhZMARMCEQAKGUMCDQhOHgIOSgcEThIJFAsRU1YWAA5bFglYCAkPDF4ZG0omAQgWBgkIE1pLCx4ODFoTAQoHHFxVUwdRBl4VUhNQGBFWDlQGUgYBEQIABwlRSxIWWAMXBloPBh4ERAENUFA="
